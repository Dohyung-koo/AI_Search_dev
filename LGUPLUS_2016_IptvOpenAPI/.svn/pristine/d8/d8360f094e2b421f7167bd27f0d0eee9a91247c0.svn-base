package com.diquest.openapi.google.log;
...
public class GoogleLogService {
	...
	public GoogleLogVO setCommonLog(GoogleLogVO returnVo) {
...
//			SEQ_ID = getNowDate(17)+random.nextInt(9999)+random.nextInt(9999);
	...
	public GoogleLogVO writeLog(GoogleLogVO vo, String was_num) {
...
//				System.out.println("logStr" + logStr);
	 ...
	 * @return
	 */
	public String makeLogStr( GoogleLogVO vo ) {
