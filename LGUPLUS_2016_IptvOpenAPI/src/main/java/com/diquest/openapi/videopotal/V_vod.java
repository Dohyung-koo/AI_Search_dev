...
public class V_vod {
	...
	public String getActorGb() {
		return actorGb;
	}
	public void setActorGb(String actorGb) {
		this.actorGb = actorGb;
	}
	...
	public String getTitleOrign() {
		return titleOrign;
	}
	public void setTitleOrign(String titleOrign) {
		this.titleOrign = titleOrign;
	}
	...
	public String getExtraActor() {
		return extraActor;
	}
	public void setExtraActor(String extraActor) {
