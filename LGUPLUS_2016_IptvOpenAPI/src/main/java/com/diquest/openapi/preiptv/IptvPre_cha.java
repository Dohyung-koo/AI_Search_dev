...
public class IptvPre_cha {
	...
	/*
	 * public Kids_cha kids_cha_test(String text) { this.serviceId = "outmax 만큼 출력";
	 * this.serviceName = text; this.serviceEngName = text; this.channelNo = text;
	 * this.programId = text; this.programName = text; this.thmImgUrl = text;
	 * this.thmImgFileName = text; this.rating = text; this.broadTime = text;
	 * this.day = text; this.overseerName = text; this.actor = text; this.PName =
	 * text; this.genre1 = text; this.genre2 = text; this.genre3 = text;
	 * this.seriesNo = text; this.subName = text; this.broadDate = text;
	 * this.localArea = text; this.avResolution = text; this.captionFlag = text;
	 * this.dvsFlag = text; this.is51Ch = text; this.filteringCode = text;
	 * this.chnlKeyword = text; this.chnlIconUrl = text; this.chnlIconFileName =
	 * text; return this; }
	 */
