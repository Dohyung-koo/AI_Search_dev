...
public class IptvottLogVO {
    ...
    public void setAPP_EXE_PATH(String APP_EXE_PATH) {
        this.APP_EXE_PATH = APP_EXE_PATH;
    }

    public String getBUY_AMONT() {
        return BUY_AMONT;
    }

    public void setBUY_AMONT(String BUY_AMONT) {
