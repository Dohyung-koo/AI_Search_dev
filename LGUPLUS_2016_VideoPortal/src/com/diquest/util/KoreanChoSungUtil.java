...
public class KoreanChoSungUtil {
	...
	public KoreanChoSungUtil() {
	}
	private static class Singleton {
		private static final KoreanChoSungUtil instance = new KoreanChoSungUtil();
	}
	public static KoreanChoSungUtil getInstance(){
	...
	public static void main(String[] args) {
		...
		String s = "테이블 밑에 손을 [숨기지 마라], 응답하라 119";
		
		System.out.println(KoreanChoSungUtil.getInstance().getBKEY(s));
		System.out.println(KoreanChoSungUtil.getInstance().getBKEYCho(s));
		System.out.println(KoreanChoSungUtil.getInstance().getFCho(s));
		System.out.println(KoreanChoSungUtil.getInstance().getFKEY(s));
		System.out.println(KoreanChoSungUtil.getInstance().getFKEYCho(s));
	}
