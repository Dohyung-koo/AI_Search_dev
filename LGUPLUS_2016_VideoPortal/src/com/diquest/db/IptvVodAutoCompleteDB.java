...
public class IptvVodAutoCompleteDB {
	...
	public IptvVodAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public IptvVodAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public List<IptvVodAutoCompleteVO> select(){
		List<IptvVodAutoCompleteVO> list = new ArrayList<IptvVodAutoCompleteVO>();
		try {
			ResultSet rs = selectPstmt.executeQuery();
			while(rs.next()){
				
				IptvVodAutoCompleteVO vo = new IptvVodAutoCompleteVO();
	...
	public int insertAll(IptvVodAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
