...
public class KidsAutoCompleteDB {
...
*/
	...
	public KidsAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public KidsAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public int insertAll(KidsAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
