...
public class KidsClassAutoCompleteDB {
...
*/
	...
	public KidsClassAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public KidsClassAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public List<KidsClassAutoCompleteVO> select(){
		List<KidsClassAutoCompleteVO> list = new ArrayList<KidsClassAutoCompleteVO>();
		try {
			ResultSet rs = selectPstmt.executeQuery();
			while(rs.next()){
				
				KidsClassAutoCompleteVO vo = new KidsClassAutoCompleteVO();
	...
	public int insertAll(KidsClassAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
