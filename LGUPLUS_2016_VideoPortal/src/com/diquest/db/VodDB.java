...
public class VodDB {
	...
	public VodDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public VodDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
...
//				vo.setCastNameMaxEng(rs.getString(16));
	...
	public int insertExistCheck(VodVO vo, Connection conn) {
	...
	public int insertexcept(VodVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
