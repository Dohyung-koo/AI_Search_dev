...
/*			"KOFIC_SUPPORTING_ACTOR",
	...
	public Golf2DB(String tableName) {
		this.TABLE = tableName;
	}
	
	public Golf2DB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
...
//				vo.setCastNameMaxEng(rs.getString(16));
	...
	public int insertExistCheck(Golf2VO vo, Connection conn) {
	...
	public int insertAll(Golf2VO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
	...
	public int update (Golf2VO vo){
		...
		try {
			...
			updatePstmt.setString(86, vo.getVideoType());
