...
public class ShowAutoCompleteDB {
	...
	public ShowAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public ShowAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public List<ShowAutoCompleteVO> select(){
		List<ShowAutoCompleteVO> list = new ArrayList<ShowAutoCompleteVO>();
		try {
	...
	public int insertAll(ShowAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getOrgId());
			insertPstmt.setString(2, vo.getKeyword());
			insertPstmt.setString(3, vo.getKeywordChosung());
			insertPstmt.setString(4, vo.getField());
			insertPstmt.setString(5, vo.getDeviceData());
			if(batch) {
