...
*/
	...
	public VrAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public VrAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public int insertAll(VrAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
