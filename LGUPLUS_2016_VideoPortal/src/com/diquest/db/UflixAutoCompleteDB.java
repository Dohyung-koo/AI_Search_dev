...
public class UflixAutoCompleteDB {
	...
	public UflixAutoCompleteDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public UflixAutoCompleteDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public List<UflixAutoCompleteVO> select(){
		List<UflixAutoCompleteVO> list = new ArrayList<UflixAutoCompleteVO>();
		try {
	...
	public int insertAll(UflixAutoCompleteVO vo) {
		int resultCnt = -1;
		try {
