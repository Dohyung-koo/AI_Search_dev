...
public class I30ChannelDB {
	...
	public I30ChannelDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public I30ChannelDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
	...
	public int insertAll(I30ChannelVO vo) {
		int resultCnt = -1;
		try {
	...
	public int update(I30ChannelVO vo) {
		int resultCnt = -1;
		try {
	...
	public int delete (I30ChannelVO vo){
		int resultCnt = -1;
		try {
