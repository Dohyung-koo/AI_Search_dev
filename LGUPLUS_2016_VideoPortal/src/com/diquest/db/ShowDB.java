...
/*			"KOFIC_SUPPORTING_ACTOR",
	...
	public ShowDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public ShowDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
...
//				vo.setCastNameMaxEng(rs.getString(16));
	...
	public int insertExistCheck(ShowVO vo, Connection conn) {
		...
		try {
			...
			insertPstmt.setString(91, vo.getActorName());
			insertPstmt.setString(92, vo.getActorNameChosung());
			//Choihu 20180808 VIDEO_TYPE 추가
			insertPstmt.setString(93, vo.getVideoType());
			//Choihu 20181012 RUN_TIME 추가
			insertPstmt.setString(94, vo.getRun_time());
			insertPstmt.setString(95, vo.getMainProperty());
			insertPstmt.setString(96, vo.getSubProperty());
			if(batch) {
	...
	public int insertAll(ShowVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
	...
	public int insertexcept(ShowVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
	...
	public int update (ShowVO vo){
		...
		try {
			...
			updatePstmt.setString(91, vo.getActorName());
			updatePstmt.setString(92, vo.getActorNameChosung());
			//Choihu 20180808 VIDEO_TYPE 추가
			updatePstmt.setString(93, vo.getVideoType());
			updatePstmt.setString(94, vo.getRun_time());

			updatePstmt.setString(95, vo.getMainProperty());
			updatePstmt.setString(96, vo.getSubProperty());
			updatePstmt.setString(97 , vo.getResultType());
			updatePstmt.setString(98 , vo.getCatGb());
			updatePstmt.setString(99 , vo.getCatId());
			updatePstmt.setString(100 , vo.getAlbumId());
