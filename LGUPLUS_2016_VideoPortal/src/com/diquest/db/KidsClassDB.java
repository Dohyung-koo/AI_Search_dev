...
public class KidsClassDB {
	...
	public KidsClassDB(String tableName) {
		this.TABLE = tableName;
	}
	
	public KidsClassDB(String tableName, boolean batch) {
		this.batch = batch;
		this.TABLE = tableName;
	}
...
//				vo.setCastNameMaxEng(rs.getString(16));
	...
	public int insertExistCheck(KidsClassVO vo, Connection conn) {
	...
	public int insertAll(KidsClassVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
	...
	public int insertexcept(KidsClassVO vo) {
		int resultCnt = -1;
		try {
			insertPstmt.setString(1, vo.getResultType());
			insertPstmt.setString(2, vo.getCatGb());
	...
	public int update (KidsClassVO vo){
		int resultCnt = -1;
		try {
	...
	public int delete (KidsClassVO vo){
		int resultCnt = -1;
		try {
